/********************************************************************************
** Form generated from reading UI file 'dlttaskform.ui'
**
...
#ifndef UI_DLTTASKFORM_H
#define UI_DLTTASKFORM_H
...
public:
    ...
    void setupUi(QWidget *DltTaskForm)
    {
        if (DltTaskForm->objectName().isEmpty())
            DltTaskForm->setObjectName("DltTaskForm");
        DltTaskForm->resize(392, 370);
        DltTaskForm->setStyleSheet(QString::fromUtf8("\n"
"    QWidget {\n"
...
"    }"));
        verticalLayoutWidget = new QWidget(DltTaskForm);
        ...
        retranslateUi(DltTaskForm);

        QMetaObject::connectSlotsByName(DltTaskForm);
    } // setupUi

    void retranslateUi(QWidget *DltTaskForm)
    {
        DltTaskForm->setWindowTitle(QCoreApplication::translate("DltTaskForm", "Form", nullptr));
        label->setText(QCoreApplication::translate("DltTaskForm", "\350\257\267\350\276\223\345\205\245\350\246\201\345\210\240\351\231\244\347\232\204\344\272\213\345\212\241\346\240\207\351\242\230\357\274\232", nullptr));
        ...
        pushButton->setText(QCoreApplication::translate("DltTaskForm", "\347\241\256\350\256\244", nullptr));
        pushButton_2->setText(QCoreApplication::translate("DltTaskForm", "\345\217\226\346\266\210", nullptr));
    } // retranslateUi

};

namespace Ui {
    class DltTaskForm: public Ui_DltTaskForm {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DLTTASKFORM_H
