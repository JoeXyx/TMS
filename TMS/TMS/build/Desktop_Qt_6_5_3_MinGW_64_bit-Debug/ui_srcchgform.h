/********************************************************************************
** Form generated from reading UI file 'srcchgform.ui'
**
...
#ifndef UI_SRCCHGFORM_H
#define UI_SRCCHGFORM_H
...
public:
    ...
    void setupUi(QWidget *srcChgForm)
    {
        if (srcChgForm->objectName().isEmpty())
            srcChgForm->setObjectName("srcChgForm");
        srcChgForm->resize(391, 366);
        srcChgForm->setStyleSheet(QString::fromUtf8("\n"
"    QWidget {\n"
...
"    }"));
        verticalLayoutWidget = new QWidget(srcChgForm);
        ...
        retranslateUi(srcChgForm);

        QMetaObject::connectSlotsByName(srcChgForm);
    } // setupUi

    void retranslateUi(QWidget *srcChgForm)
    {
        srcChgForm->setWindowTitle(QCoreApplication::translate("srcChgForm", "Form", nullptr));
        label->setText(QCoreApplication::translate("srcChgForm", "\350\257\267\350\276\223\345\205\245\350\246\201\344\277\256\346\224\271\347\232\204\344\272\213\345\212\241\346\240\207\351\242\230\357\274\232", nullptr));
        ...
        pushButton->setText(QCoreApplication::translate("srcChgForm", "\347\241\256\350\256\244", nullptr));
        pushButton_2->setText(QCoreApplication::translate("srcChgForm", "\345\217\226\346\266\210", nullptr));
    } // retranslateUi

};

namespace Ui {
    class srcChgForm: public Ui_srcChgForm {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SRCCHGFORM_H
